    ...
    units: [
      {
        ...
        lessons: [
          ...
          { id: 'l3', originalTitle: '我是小小控制员', coffinTitle: '我是守陵控制员', description: '体验手动控制棺盖开合的过程。' },
          { id: 'l4', originalTitle: '输入输出与计算', coffinTitle: '盗墓信号与机关触发', description: '输入：震动信号；计算：判断是否为盗墓贼；输出：发射毒箭。' }
        ]
      },
      {
        id: 'u2',
        ...
        lessons: [
          ...
          { id: 'l7', originalTitle: '开关量的与运算', coffinTitle: '双重机关的与逻辑', description: '只有“震动”AND“红外”同时触发，才启动自毁程序。' },
          { id: 'l8', originalTitle: '开关量的或运算', coffinTitle: '逃生通道的或逻辑', description: '按下“内部开关”OR“外部密钥”，墓门开启。' }
        ]
      },
      {
        id: 'u3',
        ...
        lessons: [
          ...
          { id: 'l11', originalTitle: '通过反馈知效果', coffinTitle: '尸身腐败度检测', description: '引入反馈：检测到温度升高，自动启动制冷。' },
          { id: 'l12', originalTitle: '闭环控制助稳定', coffinTitle: '恒温棺材助永生', description: '闭环系统：维持棺内温度在绝对零度附近的恒定。' }
        ]
      },
      {
        id: 'u4',
        ...
        lessons: [
          ...
          { id: 'l15', originalTitle: '模块组装很灵活', coffinTitle: '机关模块化设计', description: '将毒气模块与陷坑模块组合使用。' }
        ]
      },
      {
        id: 'u5',
        ...
        lessons: [
          ...
          { id: 'l18', originalTitle: '土壤湿度控制好', coffinTitle: '养尸地湿度控制', description: '保持土壤特定的湿度以维持“僵”的状态。' },
          { id: 'l19', originalTitle: '光照温度要适宜', coffinTitle: '幽冥鬼火光照调节', description: '控制磷火的亮度与环境温度。' }
        ]
      },
      {
        id: 'u6',
        ...
        lessons: [
          ...
          { id: 'l22', originalTitle: '电梯门的开与关', coffinTitle: '棺盖的滑盖控制', description: '逻辑控制：棺盖的自动滑开与闭合。' },
          { id: 'l23', originalTitle: '如果超载电梯停', coffinTitle: '陪葬品超重警报', description: '防止陪葬金银过多压塌升降台。' }
        ]
      },
      {
        id: 'u7',
        ...
        lessons: [
          ...
          { id: 'l26', originalTitle: '倒车防撞请注意', coffinTitle: '入库防撞辅助', description: '棺材推入墓穴时的距离感应雷达。' },
          { id: 'l27', originalTitle: '定速巡航的控制', coffinTitle: '黄泉路定速巡航', description: '保持灵车匀速行驶，不惊扰亡灵。' }
        ]
      },
      {
        id: 'u8',
        ...
        lessons: [
          ...
          { id: 'l30', originalTitle: '自主可控变强大', coffinTitle: '防盗墓技术自主化', description: '拒绝使用容易被现代黑客破解的通用协议，研发私有防盗协议。' }
        ]
      }
    ]
  },
    ...
    units: [
      {
        ...
        lessons: [
          ...
          { id: 'l3', originalTitle: '互联网影响新体验', coffinTitle: '赛博永生的新体验', description: '讨论意识上传对传统丧葬文化的冲击。' }
        ]
      },
      {
        id: 'u2',
        ...
        lessons: [
          ...
          { id: 'l6', originalTitle: '数字身份辨设备', coffinTitle: '数字灵位辨祖宗', description: 'IP地址：确保祭品烧给自家的祖宗（IP）而非隔壁老王。' },
          { id: 'l7', originalTitle: '域名解析换编码', coffinTitle: '族谱解析换生辰', description: 'DNS原理：将“太爷爷”解析为具体的墓地坐标。' },
          { id: 'l8', originalTitle: '路由路径靠算法', coffinTitle: '黄泉引路靠算法', description: '路由器：数据包在阴间网络中的跳转路径。' },
          { id: 'l9', originalTitle: '数据传输有新意', coffinTitle: '跨界传输有新意', description: 'TCP vs UDP：托梦（可靠）与烧纸（不可靠，可能烧了一半）。' },
          { id: 'l10', originalTitle: '综合所学建网络', coffinTitle: '搭建祠堂局域网', description: '实战：在祠堂搭建供家族内部使用的祭祀网络。' }
        ]
      },
      {
        id: 'u3',
        ...
        lessons: [
          ...
          { id: 'l13', originalTitle: '万维网安全新协议', coffinTitle: '通灵安全新协议', description: 'HTTPS：防止祭祀心愿被恶鬼（中间人）窃听。' },
          { id: 'l14', originalTitle: '互联网搜索新发展', coffinTitle: '寻祖搜索新发展', description: '搜索引擎原理：如何在茫茫鬼海中找到祖先。' },
          { id: 'l15', originalTitle: '互联网实验齐发现', coffinTitle: '招魂实验齐发现', description: '使用Ping命令测试与祖先的连通性（Latency）。' }
        ]
      },
      {
        id: 'u4',
        ...
        lessons: [
          ...
          { id: 'l18', originalTitle: '美化网页方法多', coffinTitle: '美化灵堂方法多', description: 'CSS样式：让电子灵堂庄严肃穆。' },
          { id: 'l19', originalTitle: '多人协同效率高', coffinTitle: '家族修谱效率高', description: '使用Git进行家族族谱的协同编辑。' },
          { id: 'l20', originalTitle: '组建网站跟我做', coffinTitle: '组建宗祠跟我做', description: '发布完整的家族纪念网站。' }
        ]
      },
      {
        id: 'u5',
        ...
        lessons: [
          ...
          { id: 'l23', originalTitle: '在线生活创意多', coffinTitle: '阴间生活创意多', description: '元宇宙中的陵墓装修服务。' },
          { id: 'l24', originalTitle: '在线交流新气象', coffinTitle: '跨界交流新气象', description: '即时通讯软件在“沟通”中的应用。' },
          { id: 'l25', originalTitle: '网络创新云服务', coffinTitle: '记忆存储云服务', description: '云存储：将祖先的记忆永久备份在云端（数字永生）。' },
          { id: 'l26', originalTitle: '创意展示我家乡', coffinTitle: '风水宝地我家乡', description: '利用短视频推广家乡的殡葬文化。' }
        ]
      },
      {
        id: 'u6',
        ...
        lessons: [
          ...
          { id: 'l29', originalTitle: '企业责任勇担当', coffinTitle: '殡葬企业勇担当', description: '互联网殡葬企业的社会责任。' },
          { id: 'l30', originalTitle: '网络生态建设好', coffinTitle: '阴阳生态建设好', description: '打击网络封建迷信诈骗，维护清朗空间。' }
        ]
      }
    ]
  },
    ...
    units: [
      {
        ...
        lessons: [
          ...
          { id: 'l3', originalTitle: '环境数据要感知', coffinTitle: '尸变环境要感知', description: '实战：使用温湿度传感器监测棺内环境。' },
          { id: 'l4', originalTitle: '物物相连有价值', coffinTitle: '万棺相连有价值', description: '探讨大规模棺材联网的商业/数据价值。' },
          { id: 'l5', originalTitle: '物联功能趣体验', coffinTitle: '诈尸预警趣体验', description: '体验远程查看棺材内部震动数据。' }
        ]
      },
      {
        id: 'u2',
        ...
        lessons: [
          ...
          { id: 'l8', originalTitle: '巧用蓝牙做工具', coffinTitle: '巧用蓝牙连尸身', description: '蓝牙Mesh组网在大型陵墓中的应用。' },
          { id: 'l9', originalTitle: '互联协议仍沿用', coffinTitle: 'HTTP协议仍沿用', description: 'REST API：向服务器发送“请求复活”指令。' },
          { id: 'l10', originalTitle: '物物互通有新径', coffinTitle: 'MQTT互通有新径', description: 'MQTT协议：发布/订阅模式在棺材集群管理中的优势。' }
        ]
      },
      {
        id: 'u3',
        ...
        lessons: [
          ...
          { id: 'l13', originalTitle: '门铃通知即时到', coffinTitle: '招魂铃声即时到', description: '当检测到敲击棺盖时，手机推送通知。' },
          { id: 'l14', originalTitle: '远程控制更便捷', coffinTitle: '远程揭棺更便捷', description: '通过手机App远程控制推杆电机推开棺盖。' },
          { id: 'l15', originalTitle: '面容钥匙显智能', coffinTitle: '遗容识别显智能', description: '人脸识别开锁：只有后代子孙（或本人）能打开。' }
        ]
      },
      {
        id: 'u4',
        ...
        lessons: [
          ...
          { id: 'l18', originalTitle: '数据分析与处理', coffinTitle: '尸变指数分析', description: '算法处理：判断数据是否异常（是否诈尸）。' },
          { id: 'l19', originalTitle: '数据呈现可视化', coffinTitle: '阴德数据可视化', description: 'Dashboard设计：在墓碑屏幕上显示各项指标。' },
          { id: 'l20', originalTitle: '反馈控制有算法', coffinTitle: '镇压反馈有算法', description: '自动化逻辑：检测到起尸自动播放大悲咒并锁死。' }
        ]
      },
      {
        id: 'u5',
        ...
        lessons: [
          ...
          { id: 'l23', originalTitle: '医疗设施新功能', coffinTitle: '法医设施新功能', description: '远程验尸系统的物联网实现。' },
          { id: 'l24', originalTitle: '农业生产新模式', coffinTitle: '坟头种草新模式', description: '智能灌溉系统在陵园绿化中的应用。' },
          { id: 'l25', originalTitle: '学习探究新工具', coffinTitle: '盗墓探究新工具', description: '使用传感器阵列探测地下空洞（洛阳铲2.0）。' }
        ]
      },
      {
        id: 'u6',
        ...
        lessons: [
          ...
          { id: 'l28', originalTitle: '安全防范讲策略', coffinTitle: '机关防范讲策略', description: '防火墙、物理隔离在陵墓网络中的应用。' },
          { id: 'l29', originalTitle: '自主可控意义大', coffinTitle: '自主可控防摸金', description: '为什么核心防盗系统不能用外国芯片？' },
          { id: 'l30', originalTitle: '系统安全需升级', coffinTitle: '墓室安全需升级', description: 'OTA空中升级：修复千年Bug。' }
        ]
      }
    ]
  }
